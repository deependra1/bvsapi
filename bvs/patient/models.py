...
class Patient(AbstractModel):
    ...
    provence = models.CharField(max_length=150, null=True, blank=True)
    ...
    tole = models.CharField(max_length=150, null=True, blank=True)
    foreign_address = models.CharField(max_length=255, null=True, blank=True)

    country2 = models.CharField(max_length=150, null=True, blank=True)
    provence2 = models.CharField(max_length=150, null=True, blank=True)
    district2 = models.CharField(max_length=150, null=True, blank=True)
    local2 = models.CharField(max_length=150, null=True, blank=True)
    ...
    material_status = models.CharField(max_length=50, null=True, blank=True)
    ...
    person_at_hospital = models.CharField(max_length=50, null=True, blank=True)
    relation_to_parent = models.CharField(max_length=50, null=True, blank=True)
